...
class DetermineColor:
    ...
    def callback(self,data):
        try:
            ...
            blue, red, oth = self.calculate_color(image)
            ...
            msg = data.header
            msg.frame_id = '0'
            self.determine_str(blue, red, oth)
    ...
    def calculate_color(self, image):
        ...
        if len(self.val_tmp) == 0:
            ...
            for arr in self.diff:
                ...
                if tmp[0] >= 180 and tmp[1] >=180 and tmp[2] >= 180:
                    oth += 1
                elif tmp[2] >= 180 and tmp[0] < 180 and tmp[1] < 180:
                    red += 1
                elif tmp[0] >= 180 and tmp[1] < 180 and tmp[2] < 180:
                    blue += 1
                else:
                    if tmp[0] < 180 and tmp[1] < 180 and tmp[2] < 180:
